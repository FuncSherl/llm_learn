...
IWSLT_15_EN2VI_TRAIN = {
    ...
    "dst": op.join(os.path.dirname(__file__), "./train.vi"),
}
IWSLT_15_EN2VI_TEST = {
    "src": op.join(os.path.dirname(__file__), "./test.en"),
    "dst": op.join(os.path.dirname(__file__), "./test.vi"),
}
IWSLT_15_EN2VI_DEV = {
    "src": op.join(os.path.dirname(__file__), "./dev.en"),
    "dst": op.join(os.path.dirname(__file__), "./dev.vi"),
}
IWSLT_15_EN2VI_DICT = {
    "src": op.join(os.path.dirname(__file__), "./vocab.en"),
    "dst": op.join(os.path.dirname(__file__), "./vocab.vi"),
}
"""
